...
<head>
  ...
  <title>Bookie buddie | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Bookie buddie</span>
    </a>
...
@yield('content')
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022-2023 <a href="https://adminlte.io">Sport</a>.</strong>
    All rights reserved.
